...
void MTCTaskNode::setupPlanningScene()
{
    ...
    obstacle_pose.position.z = 0.05; // na podu
...
#pragma GCC diagnostic pop
    ...
    }
    {
                                              ...
                                              {"eef", "group", "ik_frame"});
        {
            ...
            target_pose_msg.header.frame_id = "obstacle_box"; // <-- promijeni referentni frame
            /* target_pose_msg.pose.position.x = 0.7; */
            target_pose_msg.pose.position.z = 0.2 - 0.05; // visina kutije (0.2m) - objekt će biti na vrhu
        ...
        {
            // Allow collision before opening handc
